          ...
          runOnUiThread {
            ...
            val textDescription = if (dataGrabber.getJSONObject(i).getString("debit").toBigDecimal() == BigDecimal(0)) {
              "${
                ...
                bitCoinFormat.decimalToDoge(dataGrabber.getJSONObject(i).getString("credit").toBigDecimal())
              } Upgrade Level: ${
            ...
            if (dataGrabber.getJSONObject(i).getString("debit").toBigDecimal() == BigDecimal(0)) {
              doge.text = "Amount: -${bitCoinFormat.decimalToDoge(dataGrabber.getJSONObject(i).getString("credit").toBigDecimal())} DOGE"
